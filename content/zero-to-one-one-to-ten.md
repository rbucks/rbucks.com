...
About six years ago I announced on this very blog that [I was done with venture capital]({filename}im-not-fundable.md). Kaput. Over. I was going out on my own, bootstrapped, never to rely on another dollar of VC money. 

Things can change. 

Shovels [announced a $5M Seed round](https://www.shovels.ai/blog/shovels-raises-5m-seed-round-to-scale-ai-powered-building-permit-platform/) earlier this month. I'm proud of it. I wanted it. I still want it, and I still don't regret it, and I don't think I ever will. We will need this money and we will turn this $5M into many multiples of market value. It's invigorating.
...
Coming off of MightySignal, [where I took over leadership]({filename}mightysignals-new-leadership.md), I was convinced that I wanted to start another data business. I decided three things would have to be true about this next data business:
...
For the pre-seed, which I raised when we had no revenue, I just got lucky. [Zach Coelius](https://www.linkedin.com/in/zachcoelius/) from [Coelius Capital](https://coelius.vc/) knew me (or really, just knew _of_ me, but that was good enough!) So, I was able to raise the $1M I set out to raise when I wrote my [business evaluation of Shovels]({filename}business-evaluation-shovels.md).
...
This is the irony of fundraising in this stage -- you know you're _supposed_ to ask for money, but you know deep down that you don't really _need_ it. Sure, you want to pay yourself and your co-founder, but what's that? $250 or $500K for one or two years? You can't pitch the big guys with that small of a raise.
...
I struggled with the deck. It was very... _practical_. There was nothing wrong with it, but it didn't sizzle. I got plenty of meetings but I couldn't close anybody. Even my super excited lead pre-seed investor was out. He didn't think I had the vision yet. 
